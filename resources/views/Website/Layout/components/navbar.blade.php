<style>
    body {
        ...
        /* Prevent horizontal scrolling across the page */
    }
    ...
    .dropdown-menu {
        max-height: unset;
        /* Ensure no height limitation */
        overflow: hidden;
        /* Allow content to display without scrollbars */
        padding: 0.5rem 0;
        /* Add padding for better look */
        border-radius: 0.375rem;
        /* Slightly round edges for aesthetics */
    }
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link fw-bold ps-5 dropdown-toggle" href="#" role="button"
                ...
                <li class="nav-item">
                    <a class="nav-link fw-bold ps-5" href="{{ route('Free.easy') }}">Free & Easy.</a>
                </li>
                <li class="nav-item">
            ...
            <div class="d-flex align-items-center">
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle"
                        ...
                        <img src="{{ asset('website/images/user.png') }}" width="23" alt="User Profile"
                            class="me-2">
                    </a>
                        ...
                        @else
                            ...
                            <li>
                                <button type="button" class="dropdown-item" data-bs-toggle="modal"
                                    data-bs-target="#loginModal">My Profile</button>
                            </li>
                            <li>
                                <button type="button" class="dropdown-item" data-bs-toggle="modal"
...
@endif --}}
            ...
            <div class="website-description">
                ...
                <p class="w-75 text-center mx-auto">
                    A Singapore Tour and Travel Agency: With ATA, you can go for our holiday package, or just travel
                    free
                    and easy!
                </p>
