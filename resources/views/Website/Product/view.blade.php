    ...
    <section class="product-detail row p-4">
        ...
        <div class="detail d-flex align-items-center gap-2 col-6 col-lg-2 my-4">
            ...
            <div class="d-flex flex-column">
                ...
                <span class="text-secondary">Activity</span>
            </div>
        </div>
        <div class="detail d-flex flex-column gap-1 col-6 col-lg-2 my-4">
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form>
                        ...
                        {{-- Ticket Section --}}
                        <div>
                            <h6>Ticket: <span class="text-secondary">(Max 10 Members)</span></h6>
                            <div class="p-1" id="member-can" data-adult-price="70" data-youth-price="50"
                                data-children-price="30" data-max-members="10">
                                <div class="ticket-gender d-flex align-items-center gap-2 justify-content-between my-2">
                                    <div>
                                        <h6 class="small-text">Adult (+18 years)</h6>
                                    </div>
                                    <select name="adult" id="adult" class="form-control w-25 member-select"></select>
                                </div>
                                <div class="ticket-gender d-flex align-items-center gap-2 justify-content-between my-2">
                                    <div>
                                        <h6 class="small-text">Youth (13 - 17 years)</h6>
                                    </div>
                                    <select name="youth" id="youth" class="form-control w-25 member-select"></select>
                                </div>
                                <div class="ticket-gender d-flex align-items-center gap-2 justify-content-between my-2">
                                    <div>
                                        <h6 class="small-text">Children (0 - 12 years)</h6>
                                    </div>
                                    <select name="children" id="children" class="form-control w-25 member-select"></select>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div id="rooms-section">
                            ...
                            <div id="roomsDetails" data-adult-single-price="100"
                                data-adult-twin-price="80" data-child-with-bed-price="50">
                                <div class="room-details mb-3" id="room-1">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="number" class="form-control" id="adultSingle1" placeholder="0" min="0" value="0">
                                    </div>
                                    <div class="mb-2">
                                        <label for="adultTwin1" class="form-label">Adult (Twin/Triple/Quad)*</label>
                                        <input type="number" class="form-control" id="adultTwin1" placeholder="0" min="0" value="0">
                                    </div>
                                    <div class="mb-2">
                                        <label for="childWithBed1" class="form-label">Child with Bed</label>
                                        <input type="number" class="form-control" id="childWithBed1" placeholder="0" min="0" value="0">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const totalTourPriceElement = document.getElementById("total-tour-price");
        ...
        const calculateRoomTotal = () => {
            ...
            document.querySelectorAll(".room-details").forEach(room => {
                ...
                const childBed = parseInt(room.querySelector("[id^='childWithBed']").value || 0, 10);
        ...
        const updateGrandTotal = () => {
            ...
            totalTourPriceElement.textContent = `SGD ${grandTotal.toFixed(2)}`;
        };
